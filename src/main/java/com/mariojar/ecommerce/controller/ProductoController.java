...
import com.mariojar.ecommerce.service.UploadFileService;
import com.mariojar.ecommerce.service.UsuarioServiceImpl;
...
public class ProductoController {
    ...
    public String update(Producto producto, @RequestParam("img") MultipartFile file) throws IOException{          
        ...
        if (file.isEmpty()){
                //Cuando el producto es editado pero no cambia la imagen
                producto.setImagen(p.getImagen());
            } else{
                if(!p.getImagen().equals("default.jpg")){
                 upload.deleteImage(p.getImagen());
        }
                //Cuando el producto es editado y se cambia la imagen
                String nombreImagen= upload.saveImage(file);
                producto.setImagen(nombreImagen);
            }
